...
16-18 s: kssssssswssssssssssb";
        ...
        static void Main(string[] args)
        {
            ...
            foreach (var pwdEntry in entries)
            {
                ...
                var password = parts[1].TrimStart();

                if (password[range[0] - 1] == requiredChar && password[range[1] - 1] != requiredChar)
                    valid++;
                else if (password[range[0] - 1] != requiredChar && password[range[1] - 1] == requiredChar)
                    valid++;
            }
